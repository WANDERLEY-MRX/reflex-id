...
const footerLinks = [
  ...
  },
  {
    title: "Recursos",
    links: [
      { label: "Perfis exemplo", href: "/reflex/exemplo" },
  ...
  },
  {
    title: "Legal",
    links: [
      { label: "Privacidade (LGPD)", href: "/privacy" },
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-10">
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Sua identidade digital baseada em provas reais. Construa, verifique e
              compartilhe seu potencial com o mundo.
            </p>
      ...
      <div className="border-t border-border">
        <div className="container-page py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Reflex ID. Todos os direitos reservados.
          </p>
